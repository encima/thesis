...
\usepackage{float}
\usepackage{booktabs}
\usepackage[pass,paperwidth=8in,paperheight=10in]{geometry}
...
\begin{center}
\vspace*{6ex}
\textbf{\large For Charlotte Elizabeth Luke,}\\[4ex]
\textbf{\large Thank you for helping me finish this chapter}\\[2ex]
\textbf{\large and I am so glad to be writing the next one with you.}\\[12ex]
\textbf{\large Love always, }\\[2ex]
\textbf{\large Chris}\\[12ex]
		\begin{figure}[h]
		\includegraphics[width=\textwidth]{./chazza.JPG}
		\captionsetup{labelformat=empty, labelsep=space}
		\caption{For you, forever. Or something. You shush your mouth.}
		\end{figure}
\end{center}

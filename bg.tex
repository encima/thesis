...
\subsection{Issues}
	...
	While there has been a number of surveys into these challenges \cite{Hadim2006, Rahman, Yu2004}, we will detail those that we believe to be most relevant to our work.
	\subsubsection{Resource Constraints}
		Unless a WSN is deployed in an open field with a consistent supply of sunlight, there will always be some constraints that prevent nodes from running indefinitely. This may be storage, battery life or processing limitations.

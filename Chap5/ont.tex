...
In this chapter, we explain the ontology that we developed to formally define the components within K-HAS, the structure of the sensed data, the users involved with the network, as well as the format of the sensed data that is passed through the network.
...
\subsubsection{SUMO}\label{ont:sumo}

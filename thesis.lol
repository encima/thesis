...
\contentsline {lstlisting}{\numberline {6.2}Example Rule created from Existing Data}{131}{lstlisting.6.2}
...
\contentsline {lstlisting}{\numberline {B.1}Darwin-SW Representation of a Living Specimen}{176}{lstlisting.1.B.1}
\contentsline {lstlisting}{\numberline {C.1}K-HAS Ontology Source Code}{178}{lstlisting.1.C.1}
\contentsline {lstlisting}{\numberline {D.1}Example Drools File}{181}{lstlisting.1.D.1}
\contentsline {lstlisting}{\numberline {E.1}Sample Intrview Transcript}{182}{lstlisting.1.E.1}
\contentsline {lstlisting}{\numberline {H.1}Example params.xml file for a Repast simulation}{191}{lstlisting.1.H.1}

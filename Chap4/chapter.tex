...
\begin{lstlisting}[breaklines=true,label=dwc:eml,caption=Darwin Core: EML.xml]
 <creator>
            <individualName>
...
\begin{lstlisting}[breaklines=true,label=dwc:meta,caption=Darwin Core: meta.xml]
...
<archive xmlns="http://rs.tdwg.org/dwc/text/" metadata="eml.xml">
    <core encoding="UTF-8" linesTerminatedBy="\n" fieldsTerminatedBy="," fieldsEnclosedBy='' ignoreHeaderLines="1" rowType="http://rs.tdwg.org/dwc/terms/Occurrence">
        ...
        <field index="3" term="http://rs.tdwg.org/dwc/terms/associatedMedia"/>
        <field index="4" term="http://rs.tdwg.org/dwc/terms/eventDate"/>
        <field index="5" term="http://rs.tdwg.org/dwc/terms/eventTime"/>
        <field index="6" term="http://rs.tdwg.org/dwc/terms/locationID"/>
        <field index="7" term="http://rs.tdwg.org/dwc/terms/scientificName"/>
        <field index="8" term="http://rs.tdwg.org/dwc/terms/identifiedBy"/>
        <field index="9" term="http://rs.tdwg.org/dwc/terms/dateIdentified"/>
    </core>
